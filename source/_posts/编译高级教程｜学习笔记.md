...
这篇文章是2021年中国科学院大学李炼老师的《编译程序高级教程》一课的学习笔记，这门课程的内容主要是基于LLVM来做一些中间代码的优化。不建议没有学习或者了解过编译原理的同学选修，平时作业占比较大，一共三次大作业共占期末总成绩的80分，然后是期末考试只有20分。**但是作业难如牛马**，是使用LLVM来实现一些程序分析，实现一个简单的C程序解释器、数据流分析等。但是课程上的很多知识也是在我写这篇博客来整理与复习的过程中才看明白的。

相似的课程为多伦多大学的[CSCD70](https://www.youtube.com/watch?v=S_OeRTePeXg&list=PL0qj8UdnOw30ZGMcM6DwvM1J2tttyy_D6)。
...
![](/Users/wanglei/Desktop/Value.png)
...
### Assignment 1 Ast Interpreter

### Assignment 2 ControFlow Analysis

### Assignment3 Pointer Analysis
